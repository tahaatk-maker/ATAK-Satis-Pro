...
.a4c.senet-only{page-break-before:always}
  ...
  <div class="top"><div><div class="logo-top"><img src="${atakLogoSrc}" alt="ATAK · Beko · İstikbal"/></div><div class="name">${salesEsc(companyLegal)}</div><div class="meta">${salesEsc(address)}<br/>${salesEsc(phone)} · ${salesEsc(wa)} · ${salesEsc(email)} · ${salesEsc(companyTaxLine)}</div></div>
