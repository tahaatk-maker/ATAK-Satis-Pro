...
.a4c.senet-only{page-break-before:always}
  ...
  <div class="top"><div class="head-left"><div class="logo-top"><img src="${atakLogoSrc}" alt="ATAK Pazarlama"/></div><div class="name">${salesEsc(companyLegal)}</div></div><div class="mid-head"><div class="title">SATIŞ SÖZLEŞMESİ</div></div><div class="meta-row"><div class="meta-texts"><div class="meta addr">${salesEsc(address)}</div><div class="meta">${salesEsc(phone)} · ${salesEsc(wa)} · ${salesEsc(email)} · ${salesEsc(companyTaxLine)}</div></div><div class="partners"><img src="${bekoLogoSrc}" alt="beko" class="beko"/><img src="${istikbalLogoSrc}" alt="istikbal"/></div></div></div>
  <div class="rule"></div>
  <div class="grid3">
