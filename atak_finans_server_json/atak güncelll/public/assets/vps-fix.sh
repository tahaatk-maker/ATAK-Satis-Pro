...
# ATAK VPS kesin deploy — health 6.3.190-atak-geteinvoices olmadan DONE yazmaz
set -euo pipefail
BRANCH="${ATAK_BRANCH:-cursor/fatura-ayri-sekme-474e}"
EXPECT_HEALTH=6.3.190-atak-geteinvoices
EXPECT_BUILD=fix-v190
...
check "rapid360 okta authorize" grep -q "NATIVE_REDIRECT" "$SRC/lib/rapid360-d365-auth.js"
check "rapid360 cihaz ikinci hop" grep -q "deviceLoginUrl" "$SRC/lib/rapid360-d365-auth.js"
