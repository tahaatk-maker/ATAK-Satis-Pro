...
# ATAK VPS kesin deploy — health 6.3.189-atak-geteinvoices olmadan DONE yazmaz
set -euo pipefail
BRANCH="${ATAK_BRANCH:-cursor/fatura-ayri-sekme-474e}"
EXPECT_HEALTH=6.3.189-atak-geteinvoices
EXPECT_BUILD=fix-v189
...
check "rapid360 otc url" grep -q "function deviceLoginUrl" "$SRC/lib/rapid360-d365-auth.js"
check "rapid360 bozuk cihaz url" grep -q "function isBrokenDeviceLoginUrl" "$SRC/lib/rapid360-d365-auth.js"
