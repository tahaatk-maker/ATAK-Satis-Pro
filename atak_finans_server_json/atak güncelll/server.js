...
function defaultTrainingCatalog(){
  ...
  return [
    row({id:'sms-gateway',category:'iletisim',title:'SMS Gateway ve Toplu SMS',screen:'settings',screenLabel:'Ayarlar → SMS · Müşteri Ödemeleri',
      description:'Türkçe anlatımlı: SMS firması bağlama, test SMS, cari gecikme/özel SMS ve toplu gönderim.',
      url:'/assets/egitim/sms-gateway.mp4',status:'ready',duration:'~43 sn',sort:10}),
    row({id:'dashboard',category:'operasyon',title:'Dashboard ve hızlı aksiyonlar',screen:'dashboard',screenLabel:'Dashboard',
      description:'Türkçe anlatımlı: ana sayfa özeti ve Satış / Müşteri / Tahsilat kısayolları.',
      url:'/assets/egitim/dashboard.mp4',status:'ready',duration:'~40 sn',sort:20}),
    row({id:'sales-center',category:'satis',title:'Satış Merkezi',screen:'salesCenter',screenLabel:'Satış Merkezi',
      description:'Türkçe anlatımlı: müşteri seçimi, ürün, ödeme dağılımı ve satış kaydı akışı.',
      url:'/assets/egitim/sales-center.mp4',status:'ready',duration:'~35 sn',sort:30}),
    ...
    row({id:'customers',category:'finans',title:'Müşteri kartı ve cari',screen:'customersPage',screenLabel:'Müşteriler',
      description:'Türkçe anlatımlı: müşteri seçimi, cari bakiye, tahsilat, satış ve SMS aksiyonları.',
      url:'/assets/egitim/customers.mp4',status:'ready',duration:'~38 sn',sort:50}),
    row({id:'customer-payments',category:'finans',title:'Müşteri Ödemeleri (tahsilat)',screen:'customerPayments',screenLabel:'Müşteri Ödemeleri',
      description:'Türkçe anlatımlı: geciken filtre, tahsilat formu ve toplu SMS.',
      url:'/assets/egitim/customer-payments.mp4',status:'ready',duration:'~39 sn',sort:60}),
