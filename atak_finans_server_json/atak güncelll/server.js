...
function defaultTrainingCatalog(){
  ...
  return [
    row({id:'sms-gateway',category:'iletisim',title:'SMS Gateway ve Toplu SMS',screen:'settings',screenLabel:'Ayarlar → SMS · Müşteri Ödemeleri',
      description:'Mouse ile: Ayarlar → SMS, sağlayıcı seçimi, API alanları, kaydet ve test SMS.',
      url:'/assets/egitim/sms-gateway.mp4',status:'ready',duration:'~54 sn',sort:10}),
    row({id:'dashboard',category:'operasyon',title:'Dashboard ve hızlı aksiyonlar',screen:'dashboard',screenLabel:'Dashboard',
      description:'Mouse ile: KPI kartları, grafikler ve hızlı aksiyon butonları turu.',
      url:'/assets/egitim/dashboard.mp4',status:'ready',duration:'~51 sn',sort:20}),
    ...
    row({id:'customers',category:'finans',title:'Müşteri kartı ve cari',screen:'customersPage',screenLabel:'Müşteriler',
      description:'Mouse ile: müşteri seçimi, kart sekmeleri, Gecikme SMS alanı.',
      url:'/assets/egitim/customers.mp4',status:'ready',duration:'~52 sn',sort:50}),
    row({id:'customer-payments',category:'finans',title:'Müşteri Ödemeleri (tahsilat)',screen:'customerPayments',screenLabel:'Müşteri Ödemeleri',
      description:'Mouse ile: ödeme filtreleri, ödenenler listesi ve satır vurguları.',
      url:'/assets/egitim/customer-payments.mp4',status:'ready',duration:'~42 sn',sort:60}),
