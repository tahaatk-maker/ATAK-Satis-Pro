...
app.get('/health',(req,res)=>res.json({
  ...
  version:'6.3.139-egitim-senkron',
  build:'fix-v139',
...
function defaultTrainingCatalog(){
  ...
  return [
    ...
    row({id:'sales-center',category:'satis',title:'Satış Merkezi',screen:'salesCenter',screenLabel:'Satış Merkezi',
      description:'Mouse ile senkron anlatım: müşteri → ürün → nakit → makbuz.',
      url:'/assets/egitim/sales-center.mp4',status:'ready',duration:'~58 sn',sort:30}),
