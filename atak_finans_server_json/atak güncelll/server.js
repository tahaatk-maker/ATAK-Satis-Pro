...
.a4c.senet-only{page-break-before:always}
  ...
  <div class="top"><div class="head-left"><div class="logo-top"><img src="${atakLogoSrc}" alt="ATAK Pazarlama"/></div><div class="name">${htmlEsc(companyLegal)}</div></div><div class="mid-head"><div class="title">SATIŞ SÖZLEŞMESİ</div></div><div class="meta-row"><div class="meta-texts"><div class="meta addr">${htmlEsc(address)}</div><div class="meta">${htmlEsc(phone)} · ${htmlEsc(wa)} · ${htmlEsc(email)} · ${htmlEsc(companyTaxLine)}</div></div><div class="partners"><img src="${bekoLogoSrc}" alt="beko" class="beko"/><img src="${istikbalLogoSrc}" alt="istikbal"/></div></div></div>
  <div class="rule"></div>
  <div class="grid3">
