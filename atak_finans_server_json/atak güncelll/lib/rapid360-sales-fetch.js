...
async function fetchRapid360Sales(opts = {}){
  ...
  try{
    ...
    if(okta.needsOkta){
      return { ok: false, needsOkta: true, error: 'Rapid360’ı açın, Okta’yı onaylayın, Satışları oku. Mağaza 340334 ATAK.', tried: (muleTried || []).concat(okta.tried || []), tokens: okta.tokens || null };
    }
