...
assert.match(adminJs, /function fillSalesHubCard/);
assert.match(adminJs, /function salesHubIssueInvoice/);
assert.match(adminJs, /function fillSalesCustomerRail/);
assert.match(personelJs, /function fillSalesHubCard/);
